...
import club.mega.event.impl.EventRayCast;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if (this.mc.gameSettings.viewBobbing && !Mega.INSTANCE.getModuleManager().getModule(NoBob.class).isToggled())
        {
            this.setupViewBobbing(partialTicks);
        } else if(Mega.INSTANCE.getModuleManager().getModule(NoBob.class).isToggled()) {
            this.setupViewBobbing(partialTicks);
        }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        if (flag1 && this.mc.objectMouseOver != null && !entity.isInsideOfMaterial(Material.water))
        {
            ...
            {
                float[] outlineColor = {1.0F, 0.0F, 0.0F, 1.0F}; // Rot
                float[] fillColor = {0.0F, 0.0F, 1.0F, 0.4F}; // Blau mit 40% Transparenz
