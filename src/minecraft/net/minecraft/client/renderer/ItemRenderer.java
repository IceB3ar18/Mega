...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            if (this.itemToRender != null) {
                ...
                if (!KillAura.getInstance().isToggled() || AuraUtil.getTarget() == null || !KillAura.getInstance().fakeBlock.get()) {
                    if (this.itemToRender.getItem() instanceof ItemMap) {
                        ...
                        switch (enumaction) {
                            ...
                            case EAT:
                            case DRINK:
                                // EventItemRenderer beim Trinken berücksichtigen
                            ...
                            case BLOCK:
                                // EventItemRenderer beim Blocken berücksichtigen
                                GlStateManager.translate(eventItemRenderer.getX(), eventItemRenderer.getY(), eventItemRenderer.getZ());
                ...
                // EventItemRenderer berücksichtigen, wenn kein Item gehalten wird
                GlStateManager.translate(eventItemRenderer.getX(), eventItemRenderer.getY(), eventItemRenderer.getZ());
    ...
    public void updateEquippedItem() {
        ...
        ItemStack itemstack = Mega.INSTANCE.getSlotSpoofHandler().getSpoofedStack();
        boolean flag = false;
        if (this.itemToRender != null && itemstack != null) {
            if (!this.itemToRender.getIsItemStackEqual(itemstack)) {
                if (Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
                    boolean flag1 = Reflector.callBoolean(this.itemToRender.getItem(), Reflector.ForgeItem_shouldCauseReequipAnimation, this.itemToRender, itemstack, this.equippedItemSlot != Mega.INSTANCE.getSlotSpoofHandler().getSpoofedSlot());
                    if (!flag1) {
                        this.itemToRender = itemstack;
                        this.equippedItemSlot = Mega.INSTANCE.getSlotSpoofHandler().getSpoofedSlot();
                        return;
                    }
                }
