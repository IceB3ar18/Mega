...
import club.mega.module.impl.visual.Nametags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        ...
        if (!Objects.requireNonNull(Mega.INSTANCE.getModuleManager().getModule(Nametags.class)).isToggled() && !Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
