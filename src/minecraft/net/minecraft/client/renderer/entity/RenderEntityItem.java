...
import club.mega.module.impl.visual.ItemPhysics;
import club.mega.util.ClientPyhsics;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        if (Mega.INSTANCE.getModuleManager().getModule(ItemPhysics.class).isToggled()) {

            ClientPyhsics.doRender(entity, x, y - 0.2, z, entityYaw, partialTicks);
        } else {
