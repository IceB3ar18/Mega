...
public abstract class GuiSlot
{
    ...
    public void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_)
    {
    }
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
            ...
            RenderUtil.drawRect(0,0,sr.getScaledWidth(),this.top, new Color(0,0,0,150));
            RenderUtil.drawRect(0,this.bottom, sr.getScaledWidth(), this.height, new Color(0,0,0,150));
