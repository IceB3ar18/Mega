...
import club.mega.module.impl.hud.Blur;
import club.mega.module.impl.hud.ModuleList;
import club.mega.module.impl.visual.Hotbar;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (scoreobjective1 != null && !Mega.INSTANCE.getModuleManager().getModule(club.mega.module.impl.visual.Scoreboard.class).isToggled())
        {
        ...
        EventRenerChat eventRenerChat = new EventRenerChat(this.updateCounter);
        eventRenerChat.fire();
        ...
        final EventRender eventRender = new EventRender(partialTicks);
        eventRender.fire();
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        ...
        {
            Blur blur = Mega.INSTANCE.getModuleManager().getModule(Blur.class);
            blur.blurScreen();
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            this.zLevel = -90.0F;
            int l;
            if ((Mega.INSTANCE.getModuleManager().getModule(Hotbar.class)).isToggled()) {
                double x = (i - 91);
                double y = (sr.getScaledHeight() - 22);
                double width = (i - 91 + 182) - x;
                double height = (sr.getScaledHeight() - 22 + 22) - y;
                if(!Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).rounded.get()) {
                    RenderUtil.drawRect(x, y, width, height, getColor());
                } else {
                    RenderUtil.drawRoundedRect(x, y, width, height, Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).radius.getAsFloat() , getColor());
                }

                l = entityplayer.inventory.currentItem;
                if(!Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).rounded.get()) {
                    RenderUtil.drawRect((double)(i - 91 - 1 + l * 20 + 2), (double)(sr.getScaledHeight() - 22 - 1 + 2), 20.0, 20.0, ((Hotbar)Mega.INSTANCE.getModuleManager().getModule(Hotbar.class)).selection.getColor());

                } else {
                    RenderUtil.drawRoundedRect((double)(i - 91 - 1 + l * 20 + 2) - 1, (double)(sr.getScaledHeight() - 22 - 1 + 2) - 1, 22.0, 22.0, Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).radius.getAsFloat(), ((Hotbar)Mega.INSTANCE.getModuleManager().getModule(Hotbar.class)).selection.getColor());
                ...
                int index1 = entityplayer.inventory.currentItem;
                this.drawTexturedModalRect(i - 91 - 1 + index1 * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            }
    ...
    private Color getColor() {
        ...
        Color[] colors;
        ListSetting mode = Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).mode;
        if (mode.is("Normal")) {
            colors = new Color[]{Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).colornormal.getColor()};
        } else if (mode.is("Fade") && !Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).thirdColor.get()) {
            colors = new Color[]{Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).color1.getColor(), Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).color3.getColor()};
        } else {
            colors = new Color[]{Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).color1.getColor(), Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).color2.getColor(), Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).color3.getColor()};

        }
        return ColorUtil.interpolateColorsBackAndForth(Mega.INSTANCE.getModuleManager().getModule(Hotbar.class).speed.getAsInt(), 0, colors, false);
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        int j1 = Mega.INSTANCE.getModuleManager().isToggled(ModuleList.class) ? Mega.INSTANCE.getModuleManager().getModule(ModuleList.class).getHeight() + 20 + i1 : scaledRes.getScaledHeight() / 2 + i1 / 3;
        int k1 = 3;
        ...
        for (Score score1 : collection)
        {
            ...
            //RenderUtil.drawBlurredRect(l1 - 2, k + this.getFontRenderer().FONT_HEIGHT, l - (l1 - 2), k - (k + this.getFontRenderer().FONT_HEIGHT), new Color(1, 1, 1, 160));
            ScaledResolution sr = new ScaledResolution(mc);
            //RenderUtil.drawBlurredRect(l1 - 2, k + this.getFontRenderer().FONT_HEIGHT, sr.getScaledWidth() - l1 - 2, k - (k + this.getFontRenderer().FONT_HEIGHT), new Color(1,1,1));
