...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                if (Minecraft.getMinecraft().currentScreen instanceof GuiAltManager || Minecraft.getMinecraft().currentScreen instanceof ConfigGui)
    ...
    public void drawTextBox(String placeholderText)
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            ...
            if (this.text.isEmpty() && !this.isFocused) {
                ...
                s = this.fontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            }
