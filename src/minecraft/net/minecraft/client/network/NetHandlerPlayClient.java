        ...
        if (s.startsWith("level://"))
        {
            ...
            if (file2.isFile())
            {
                ...
                Futures.addCallback(this.gameController.getResourcePackRepository().setResourcePackInstance(file2), new FutureCallback<Object>()
                {
                    ...
                    {
                        net.minecraft.client.network.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                    }
                    public void onFailure(Throwable p_onFailure_1_)
                    {
                        net.minecraft.client.network.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
                    }
                });
            }
            else
        ...
        else
        {
            ...
            else
            {
                this.gameController.addScheduledTask(new Runnable()
                {
                    public void run()
                    {
                        net.minecraft.client.network.NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                        {
                            public void confirmClicked(boolean result, int id)
                            {
                                net.minecraft.client.network.NetHandlerPlayClient.this.gameController = Minecraft.getMinecraft();

                                if (result)
                                {
                                    if (net.minecraft.client.network.NetHandlerPlayClient.this.gameController.getCurrentServerData() != null)
                                    {
                                        net.minecraft.client.network.NetHandlerPlayClient.this.gameController.getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.ENABLED);
                                    }

                                    net.minecraft.client.network.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.ACCEPTED));
                                    Futures.addCallback(net.minecraft.client.network.NetHandlerPlayClient.this.gameController.getResourcePackRepository().downloadResourcePack(s, s1), new FutureCallback<Object>()
                                    {
                                        public void onSuccess(Object p_onSuccess_1_)
                                        {
                                            net.minecraft.client.network.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                                ...
                                else
                                {
                                    if (net.minecraft.client.network.NetHandlerPlayClient.this.gameController.getCurrentServerData() != null)
                                    {
                                        net.minecraft.client.network.NetHandlerPlayClient.this.gameController.getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.DISABLED);
                                    }

                                    net.minecraft.client.network.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.DECLINED));
                                }

                                ServerList.func_147414_b(net.minecraft.client.network.NetHandlerPlayClient.this.gameController.getCurrentServerData());
                                net.minecraft.client.network.NetHandlerPlayClient.this.gameController.displayGuiScreen((GuiScreen)null);
                            }
