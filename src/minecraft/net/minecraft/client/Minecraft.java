...
import club.mega.module.impl.combat.TickBase;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void runGameLoop() throws IOException
    {
        ...
        TickBase tickBase = Mega.INSTANCE.getModuleManager().getModule(TickBase.class);

        for(int j = 0; j < this.timer.elapsedTicks; ++j) {
            if(tickBase.hasBased && tickBase.isToggled() && AuraUtil.getTarget() != null && tickBase.getDistanceToEntity(AuraUtil.getTarget()) > tickBase.range.getAsDouble()) {
                tickBase.hasBased = false;
            }
    ...
    public void runParticleTick() {
        if (this.theWorld != null && !this.isGamePaused) {
    ...
    public void runTick() throws IOException
    {
       ...
       // System.out.println(currentScreen);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            EventClickMouse eventClick = new EventClickMouse(this.thePlayer.inventory.currentItem);
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Mega.INSTANCE.getDiscordRP().update("Singleplayer", "");
