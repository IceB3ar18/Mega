...
public class AxisAlignedBB
{
    ...
    public AxisAlignedBB expand(Entity e, double size) {
        double d0 = e.getPosition().getX() - size;
        double d1 = e.getPosition().getY() - size;
        double d2 = e.getPosition().getZ() - size;
        double d3 = e.getPosition().getX() + size;
        double d4 = e.getPosition().getY() + size;
        double d5 = e.getPosition().getZ() + size;
        return new AxisAlignedBB(d0, d1, d2, d3, d4, d5);
    }
