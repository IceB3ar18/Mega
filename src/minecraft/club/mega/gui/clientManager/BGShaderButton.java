...
public class BGShaderButton extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            int var10000 = (int)((double)this.width * scale);
            var10000 = (int)((double)this.height * scale);
            ...
            //System.out.println("Curren use shader: " + BGShaderUtil.getInstance().getCurrentShader());
            if (BGShaderUtil.getInstance().getCurrentShader().equalsIgnoreCase(this.displayString + ".fsh")) {
